              ...
              return ListTile(
                ...
                onTap: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                        content:
                            Text('已选择 ${_getAccentColorName(color)}，重启应用生效')),
                  );
                },
              );
            },
                ...
                builder: (context, ref, _) {
                  ...
                  return ListTile(
                    ...
                    onTap: config.enabled
                        ? () => _showCrossfadeDurationDialog(context, ref)
                        : null,
                  );
                },
              ),
              ...
              Consumer(
                builder: (context, ref, _) {
                  ...
                  return SwitchListTile(
                    ...
                    value: gapless,
                    onChanged: (value) => ref
                        .read(gaplessPlaybackProvider.notifier)
                        .setEnabled(value),
                  );
                },
              ),
          ...
          child: Column(
            children: [
              ListTile(
                ...
                subtitle: Text(downloadDir.isNotEmpty
                    ? downloadDir
                    : '默认 (应用文档目录/Downloads)'),
                trailing: const Icon(Icons.chevron_right),
              ...
              if (directories.isNotEmpty) ...[
                ...
                ...directories.map((dir) => ListTile(
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () => ref
                            .read(scanDirectoriesProvider.notifier)
                            .removeDirectory(dir),
                      ),
                    )),
              ],
              ...
              Consumer(
                builder: (context, ref, _) {
                  ...
                  return SwitchListTile(
                    ...
                    value: autoPlay,
                    onChanged: (value) => ref
                        .read(autoPlayOnStartProvider.notifier)
                        .setEnabled(value),
                  );
                },
              ),
              Consumer(
                builder: (context, ref, _) {
                  ...
                  return SwitchListTile(
                    ...
                    value: resumePos,
                    onChanged: (value) => ref
                        .read(resumePositionProvider.notifier)
                        .setEnabled(value),
                  );
                },
              ),
                ...
                builder: (context, ref, _) {
                  ...
                  return SwitchListTile(
                    ...
                    onChanged: (value) async {
                      ...
                      if (value) {
                        await ref
                            .read(windowManagerServiceProvider)
                            .setAutoStart(true);
                      }
                    },
                  );
...
class _CacheSection extends ConsumerWidget {
          ...
          child: Column(
            children: [
                      ...
                      return ListTile(
                        ...
                        trailing: TextButton(
                          onPressed: () => _clearCache(
                              context, '封面', cacheService.clearDiskCache),
                          child: const Text('清理'),
                        ),
                      );
                    },
              ...
              Consumer(
                builder: (context, ref, _) {
                  ...
                  return ListTile(
                    ...
                    trailing: TextButton(
                      onPressed: () => _clearCache(context, '歌词',
                          () async => lyricsService.clearCache()),
                      child: const Text('清理'),
                    ),
                  );
                },
              ...
              ListTile(
                ...
                title:
                    const Text('清理所有缓存', style: TextStyle(color: Colors.red)),
  ...
  void _clearCache(
      BuildContext context, String type, Future<void> Function() clearFunc) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
...
final downloadDirectoryProvider =
    StateNotifierProvider<DownloadDirectoryNotifier, String>((ref) {
